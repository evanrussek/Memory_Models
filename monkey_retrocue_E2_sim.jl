...
if on_cluster
    to_save_folder = "/scratch/gpfs/erussek/Memory_Models/monkey_retro_E2"
else
    to_save_folder = "/Users/erussek/Dropbox/Griffiths_Lab_Stuff/Data/Memory_Models/monkey_retro_E2"
end
...
N_Seconds_Pre_Vals = [2, 4, 8, 13]
N_Seconds_Post_Vals = [2, 6, 11]

# For trials with no retro-cue - start from .25 seconds and multiply by 1.5 8 times
N_Seconds_NoCue = [4, 8, 10, 13, 15]
...
eps_vals = collect(1:-.04:.01) # 17

# quanta values
q_vals = collect(2:2:50) #

# NT vals
NT_vals = [25,50,100,200,400]#[800]#[25, 50, 100, 200, 400, 800]
