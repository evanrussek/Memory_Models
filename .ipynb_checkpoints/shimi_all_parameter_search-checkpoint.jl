...
if on_cluster
    ...
    to_save_folder = "/Users/erussek/Dropbox/Griffiths_Lab_Stuff/code/Memory_Models/shimi_all_parameter_search_v2"
end
...
# 
NT_vals = [400, 800, 1600] # run w these now... 
...
n_jobs_per_run = 70 # should be about 30 minutes...
...
for this_job_idx in these_jobs
    ...
    local job_res_2 = sim_exp2(epsilon, N_Quanta, NT_per_Second; mem_slope = mem_slope);
